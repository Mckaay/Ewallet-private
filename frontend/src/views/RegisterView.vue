...
<template>
  <header class="top-logo">
    <svg xmlns="http://www.w3.org/2000/svg" width="123" height="22" viewBox="0 0 123 22" fill="none">
      <path
        d="M8.96495 21.44H2.94895V10.24H0.772949V5.312H3.07695C3.71695 2.272 6.69295 0 11.9729 0H13.2529V4.288H11.0129C9.34895 4.288 8.54895 4.448 8.58095 5.312H13.2529V10.24H8.96495V21.44Z"
        fill="white"/>
      ...
      <path
        ...
        fill="white"/>
      <path
        d="M69.3689 21.44H63.3529V5.312H68.9849V10.208H69.3049C69.6569 7.52 71.4169 4.992 75.7369 4.992C80.0889 4.992 82.1369 7.616 82.1369 11.104V21.44H76.1209V13.312C76.1209 11.072 75.2889 10.368 72.6649 10.368C70.0089 10.368 69.3689 11.04 69.3689 13.12V21.44Z"
        fill="white"/>
      <path
        d="M93.2915 21.76C87.5634 21.76 83.9155 18.592 83.9155 13.376C83.9155 8.128 87.5634 4.992 93.2915 4.992C98.7954 4.992 102.315 7.808 102.315 12.128V12.64H96.3315V12.384C96.3315 10.72 95.1154 10.368 93.1634 10.368C90.9554 10.368 89.8994 10.848 89.8994 13.376C89.8994 15.872 90.9554 16.352 93.1634 16.352C95.1154 16.352 96.3315 16.032 96.3315 14.368V14.08H102.315V14.624C102.315 18.912 98.7954 21.76 93.2915 21.76Z"
        fill="white"/>
      <path
        d="M113.235 21.76C107.763 21.76 103.923 19.424 103.923 13.376C103.923 8.128 107.731 4.992 113.107 4.992C118.675 4.992 122.227 7.776 122.227 12.96C122.227 13.504 122.195 13.92 122.131 14.496H109.491C109.587 16.448 110.451 16.992 113.011 16.992C115.443 16.992 116.083 16.576 116.083 15.616V15.264H122.099V15.648C122.099 19.232 118.675 21.76 113.235 21.76ZM112.979 9.6C110.771 9.6 109.843 10.08 109.587 11.456H116.403C116.179 10.08 115.219 9.6 112.979 9.6Z"
        fill="white"/>
    </svg>
  </header>
